...
export default async function AdminSocialsPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Social Links"
        description="Manage LinkedIn, Instagram, GitHub, and any other active profile links."
      />
            ...
            <details key={link.id} className={panelClass}>
              <summary className="cursor-pointer list-none">
                <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                  ...
                  <span className="rounded-full border border-slate-500/20 px-3 py-1 text-xs text-slate-300">
